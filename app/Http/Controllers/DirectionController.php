...
class DirectionController extends AppBaseController
{
    ...
    public function index(UserDataTable $userDataTable)
    {
        ...
        return $userDataTable->render('directions.index');
    }
    ...
    public function create()
    {
        ...
        return view('directions.create', compact('tags'));
    }
    ...
    public function show($id)
    {
        ...
        return view('directions.show', compact('user', 'tags', 'documents','globalPermissions'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('directions.edit')->with('user', $user)->with('tags', $tags);
    }
