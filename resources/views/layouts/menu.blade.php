<li class="{{ Request::is('admin/home*') ? 'active' : '' }}">
    <a href="{!! route('admin.dashboard') !!}"><i class="fa fa-home"></i><span>หน้าแรก</span></a>
</li>
...
<li class="{{ Request::is('admin/documents*') ? 'active' : '' }}">
    <a href="{!! route('documents.index') !!}"><i
            class="fa fa-file"></i><span>แฟ้มเอกสาร</span></a>
</li>
@endcan
@can('read directions')
    <li class="{{ Request::is('admin/directions*') ? 'active' : '' }}">
        <a href="{!! route('directions.index') !!}"><i class="fa fa-file"></i><span>หนังสือภายใน</span></a>
    </li>
@endcan
@can('read users')
    <li class="{{ Request::is('admin/users*') ? 'active' : '' }}">
        <a href="{!! route('users.index') !!}"><i class="fa fa-users"></i><span>ผู้ใช้งาน</span></a>
    </li>
@endcan
@can('read tags')
    ...
    <li class="{{ Request::is('admin/tags*') ? 'active' : '' }}">
        <a href="{!! route('tags.index') !!}"><i
                class="fa fa-tags"></i><span>แท็ก</span></a>
    </li>
@endcan
