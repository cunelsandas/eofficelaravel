...
<head>
    <meta charset="UTF-8">
    <title>@yield('title') | ระบบงานสารบรรณอิเล็กทรอนิกส์</title>
...
@if (!Auth::guest())
    <div class="wrapper">
        ...
        <header class="main-header">
            ...
            <!-- Logo -->
            <a href="{{route('admin.dashboard')}}" style="background-color: black" class="hidden-xs logo">
                <span class="logo-mini"><b style="font-family: 'Prompt', sans-serif;">{{config('settings.system_title')[0]}}</b></span>
                <span class="logo-lg"><b style="font-family: 'Prompt', sans-serif;">{{config('settings.system_title')}}</b></span>
            </a>
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown user user-menu">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="user-header" style="background-color: seagreen">
                                    <img src="{{asset(config('settings.system_logo'))}}"
                                ...
                                <li class="user-footer">
                                    <div class="pull-left">
                                        <a href="{{route('profile.manage')}}" class="btn btn-default btn-flat">โปรไฟล์</a>
                                    </div>
