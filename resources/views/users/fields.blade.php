...
<div class="box box-primary">
    <div class="box-header no-border">
        <h3 class="box-title" style="font-family: 'Prompt', sans-serif;">รายละเอียดผู้ใช้งาน</h3>
    ...
    <div class="box-body">
        <div class="row">
            ...
            <div class="form-group col-sm-12 col-lg-12 {{ $errors->has('description') ? 'has-error' :'' }}">
                {!! Form::label('description', 'รายละเอียด(ข้อมูลอื่น ๆ):') !!}
...
@can('user manage permission')
    <div class="box box-primary">
        <div class="box-header no-border">
            <h3 class="box-title">สิทธิ์การเข้าถึงทั้งหมด</h3>
        ...
        <div class="box-body">
            <div class="row">
                <div class="col-sm-12">
                    <div class="row">
                        <div class="col-sm-4">
                            <label class="control-label">ระบบผู้ใช้งาน</label><br>
...
{{--                            <label class="control-label">{{ucfirst(config('settings.tags_label_plural'))}}</label><br>--}}
                            <label class="control-label">ระบบแท็ก</label><br>
...
{{--                                class="control-label">{{ucfirst(config('settings.document_label_plural'))}}</label><br>--}}
                            <label
                                class="control-label">ระบบเอกสาร</label><br>
...
{{--            <h3 class="box-title">{{ucfirst(config('settings.tags_label_plural'))}} Wise Permissions</h3>--}}
            <h3 class="box-title">สิทธิ์การเข้าถึงโดยแท็ก</h3>
            <div class="box-tools pull-right">
                <button type="button" class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i>
                </button>
            </div>
...
{{--                                    new {{config('settings.tags_label_singular')}}</button>--}}
                                <button type="button" onclick="addRow()" class="btn btn-success btn-xs">เพิ่มแท็กใหม่</button>
                            </td>
                        </tr>
                        </tfoot>
                    </table>
...
<div class="form-group">
    ...
    <a href="{!! route('users.index') !!}" class="btn btn-warning">ยกเลิก</a>
</div>
