...
class SettingsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        \App\Setting::create(['name'=>'system_title','value'=>'Eoffice Core']);
        ...
        \App\Setting::create(['name'=>'default_file_validations2','value'=>'mimes:pdf']);
        \App\Setting::create(['name'=>'default_file_maxsize2','value'=>'100']);
